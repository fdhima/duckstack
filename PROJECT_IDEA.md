...
## Overview
Build a production-grade analytics platform that runs entirely on your local machine using Docker.
...
*   **Warehouse (The Brain):** DuckDB (High-performance OLAP).
...
## Core Requirements
1.  **Containerized Environment:** Everything MUST run via a single `docker-compose.yml` file.
